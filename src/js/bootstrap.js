...
Bootstrap.i18nLoader = function i18nLoader(cb) {
    ...
    $.getJSON("../i18n/languages.json", function getI18n(json) {
        ...
        for(var lang in json) {
            ...
            // Load only custom languages for the app
            if(Kiwapp.get().shopParameters !== undefined && "lang" in Kiwapp.get().shopParameters) {

                // Set the first lang to be our default one
                current = Kiwapp.get().shopParameters.lang[0];
                if(Kiwapp.get().shopParameters.lang.indexOf(lang) > -1) {
